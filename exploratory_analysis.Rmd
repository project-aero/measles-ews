...
# plotbreaks(data = tsir_data, threshold = 10)
...
ggplot(beta_est, aes(x = time, y = beta*scale_factor)) +
  geom_ribbon(aes(ymax = betahigh*scale_factor, ymin = betalow*scale_factor), alpha = 0.5, color = "grey") +
  geom_line(color = "white") +
  labs(x = "Two-week period", y = expression(beta[w])) +
  theme_minimal()
