...
These results suggest that although distributional changes in indicators occur prior to disease elimination, interpreting these changes in terms of loss of stability of an equilibrium, or declining $R_e$, requires a model which accounts for complicating system features such as seasonality, non-linearity, damped oscillations, and local extinction.
