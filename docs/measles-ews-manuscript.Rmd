...
We considered nine candidate early warning signals (Table Sx).
We used the `spaero::get_stats()` function [@ODea2018] in R [@R2017] to calculate EWS according to the formulas in Table Sx.
