...
To ensure identifiability, we assumed the incubation period was fixed at $1/\eta = 8$ days and the infectious period was fixed at $1/\gamma = 5$ days.
...
Our model for Agadez performs poorly relative to the other cities, but still better than non-mechanistic models (table S1).
...
The EWS generally performed as expected by theory on the approach to re-emergence.
...
In all, the suite of EWS suggest that indicators of critical slowing down have some predictive value for emergence and elimination events.
...
Using empirically-based disease transmission models, we found that generic indicators of critical slowing down were informative of simulated re-emergence and elimination of measles.
