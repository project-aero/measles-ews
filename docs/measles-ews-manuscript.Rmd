...
These data are ideal for testing theory on CSD in disease dynamics because each city has a different population size, different dynamics in terms of outbreak sizes and length of inter-epidemic periods, and has different amounts of demographic stochasticity due to differences in population size.
