...
In addition to comparing model expectations to in-sample observed data, we also compared our fitted SEIR models to two benchmarking models: a negative binomial sampling model that assumes independent and identically distributed observations and a SARIMA model (electronic supplement).
...
A potential limitation of our findings is that the susceptible discount factors in our simulations study (figure \ref{emerge-aucs}*c*) might be smaller than the factors that occur in reality.
