...
Our results support efforts to develop model-independent early warning systems for infectious diseases [@Han2016].
We have shown that critical slowing down precedes tipping points in stochastic models that were fit to data with state-of-the-art methods, but how to operationalize the phenomenon of critical slowing down remains an open research area [@Shmueli2010].
...
Early warning signals, though powerful and now accompanied with additional support, will likely be just one part of a decision-support toolkit.
