...
We split the remaining time series into two windows of equal length (figure S2).
...
We define the null interval as the window of time that ends at the start of the vaccination campaign (year 49) and starts at a time that results in an interval equal in length the test interval (figure S3).
