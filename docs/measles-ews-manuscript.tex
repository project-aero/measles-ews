...
On the approach to re-emergence, the EWS generally perform as expected,
...
(Figs. \ref{emerge-aucs}, \ref{elim-aucs}). In many cases, the variance
is expected to increase as a critical transition is approached
{[}4,9,17{]}, and we find this to be the case for re-emergence. The
