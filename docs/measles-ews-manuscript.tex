...
model (\emph{13}). See Fig. Sx for visualization of how susceptible
discounting factor and the vaccination speed map to number of weeks in
the null and test intervals. \label{aucs}}
\end{figure}
...
combined with demographic stochasticity (\emph{10}, \emph{12}). Thus,
re-emergence may prove difficult to anticipate in ``fast'' transmission
systems, as demonstrated theoretically by (\emph{12}) and seen
empirically here in the Niamey dynamics (Figs. \ref{scatters}B,
\ref{aucs}A).
