...
\journal{Proceedings of the Royal Society B}\usepackage{lineno}\linenumbers\usepackage{mathptmx}\renewcommand{\theaffn}{\arabic{affn}}\usepackage{setspace}\onehalfspacing
...
signals using empirically based models}
   ...
   \cortext[c1]{Current address: Western Ecosystems Technology, Inc., 200 S. Second
...
\texttt{pomp} {[}29,30{]} to conduct the MIF procedure. To initialize
