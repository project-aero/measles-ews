...
test_stats <- spaero::get_stats(
    x = log(niamey_test$cases+1),
    center_trend = "local_constant", 
    center_kernel = "uniform", 
    center_bandwidth = 35, 
    stat_trend = "local_constant", 
...
variance <- test_stats[["variance"]]
plot_it(niamey_test$date, cases = niamey_test$cases, ews = variance, lab = "variance", title = NULL)
```
