...
And, logliks are larger for null models where I set rw_sigma = 0.
...
ll_null <- logmeanexp(replicate(5, logLik(pfilter(pomp_objects[[1]], Np = particles))), se=TRUE)
