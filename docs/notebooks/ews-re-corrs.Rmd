...
In all the plots below, the red/blue lines show the $R_E$ trajectory, with red indicating when $R_E$ is supercritical (above 1).
The black lines are the trajectory of the EWS as indicated on the right y-axis label.
...
for(do_city in unique(sim_ews$city)){
  ...
  axis(side = 4)
  mtext(side = 4, line = 3, "Log variance (+1)")
}
