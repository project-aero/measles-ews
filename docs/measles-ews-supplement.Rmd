...
These bandwidths are the number of weeks that occur in the null and test intervals.

```{r bw-weeks, fig.width=8.5, fig.height=4, message=FALSE, warning=FALSE, echo = FALSE, fig.cap="Length of null and test intervals (in weeks) for emergence and elimination simulations at different parameter values."}
