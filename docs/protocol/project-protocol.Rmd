...
The goal is fit a model to estimate:
 ...
 + The latent *S* and *I* latent states
...
\noindent{}where $\mu_t$ is birth rate at time *t*, $\gamma$ is the time-invariant recovery rate, $\psi_t$ is rate of imported infections, and $\lambda_t$ is the time-varying force of infection.
