...
We show 3 ten-year slice of the simulated time series of S and I for each city. The number on the top indicates the speed at which the vaccination rate begins increasing at year 50, but the vaccination rates are all 70% throughout the period shown. Thus the columns essential are illustrating separate realizations of simulations with the same parameters.

The dynamics may be separated into 2 distinct phases: One in which the number of suscpeptibles builds slowly, and another in which epidemics occur and the number susceptible drops rapidly. The periods containing conspicuous epidemic spikes can be readily located simply by fitting a smoother to the S variable and finding the regions where S does not increase for more than 5 weeks. We use this method to split the time series into epidemics and inter-epidemic periods. Clearly the length of these interepidemic periods is highly variable for all parameters.