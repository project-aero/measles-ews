...
Now the inhibition effect of recent epidemic history is modeled as the extent to which epidemic size decreases with the filter of past epidemics. We assume a linear relationship for simplicity. We estimate this effect in both the steady and increasing vaccination time periods by a least squares model fit. If the epidemic size decreases more with the filter in the increasing vaccination period, then the conclusion is that the past epidemics are inhibiting current epidemics more in this period. Consqequently, the AUC of this indicator can be calculated as the fraction of times in our data in which we concluce that inhibition is stronger in the increasing-vaccination period.
