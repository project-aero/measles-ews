...
model{
  ...
  psi ~ dunif(0.7, 1.4)  # slightly weird range b/c AR(1) is on log scale now
  psi2 ~ dunif(0, 1)
...
mcmc_results <- coda.samples(
  model, 
  variable.names = c("Iobs", "I", "S", "Rnaught", "gamma", "beta", "rho", "escape_prob", "psi", "psi2", "theta", "r", "sigma_gamma"), 
  n.iter = 20000, 
  n.thin = 1
)
