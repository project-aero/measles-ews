...
model{
  ...
  for(t in 1:(ntimes-1)){
    ...
    escape_prob[t] = (1 + (beta[t] * I[t]) / kappa)^(-kappa)
...
mcmc_results <- coda.samples(
  model, 
  variable.names = c("Iobs", "I", "S", "Rnaught", "gamma", "beta", "rho", "escape_prob", "psi", "psi2", "theta", "r", "sigma_gamma","epsilon", "S02", "I0", "gamma0", "intercept", "base"), 
  n.iter = 5000, 
  n.thin = 1
)
